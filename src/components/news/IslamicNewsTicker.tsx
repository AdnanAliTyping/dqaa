  ...
  const [newsItems] = useState<NewsItem[]>([
    {
      id: '1',
      text: isMalayalam ? 
        "🕌 ഇസ്ലാമിക് കലണ്ടർ പ്രകാരം പ്രധാന ദിനങ്ങൾ ട്രാക്ക് ചെയ്യുക. അക്കാദമിയിൽ നിന്നുള്ള അപ്ഡേറ്റുകൾക്കായി കാത്തിരിക്കുക." :
        "🕌 Track major Islamic calendar dates. Stay tuned for updates from the Academy.",
      timestamp: new Date(),
      type: 'announcement'
    },
    {
